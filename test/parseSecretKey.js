...
test('parse MINISIGN generated key file', function (t) {
  ...
  fs.readFile('./test/fixtures/noString.key', function (err, data) {
    t.error(err)
...
test('comment removed from MINISIGN file', function (t) {
  fs.readFile('./test/fixtures/missingComment.key', function (err, data) {
    t.error(err)
...
test('line breaks within key', function (t) {
  fs.readFile('./test/fixtures/lineBreakStart.key', function (err, data) {
    t.error(err)
    t.throws(() => minisign.parseSecretKey(data), '[ERR_ASSERTION]')
    t.end()
  })
...
test('line break at the end of key', function (t) {
  fs.readFile('./test/fixtures/lineBreakEnd.key', function (err, data) {
    t.error(err)
    t.throws(() => minisign.parseSecretKey(data), '[ERR_ASSERTION]')
    t.end()
  })
...
test('missing line break after comment', function (t) {
  fs.readFile('./test/fixtures/missingLineBreak.key', function (err, data) {
    t.error(err)
    t.throws(() => minisign.parseSecretKey(data), '[ERR_ASSERTION]')
    t.end()
  })
